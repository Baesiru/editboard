...
public class CommentController {
    ...
    public ResponseEntity<Object> createComment(@PathVariable Long boardId, @RequestBody RequestComment requestComment) {
    ...
    public ResponseEntity<Object> deleteComment(@PathVariable Long commentId, @RequestBody RequestCommentInfo requestCommentInfo) {
        commentService.deleteComment(commentId, requestCommentInfo);
        return ResponseEntity.ok("댓글이 삭제되었습니다.");
    }

    @PostMapping("/api/comment/{commentId}/check")
    public ResponseEntity<Object> checkComment(@PathVariable Long commentId, @RequestBody RequestCommentInfo requestCommentInfo) {
